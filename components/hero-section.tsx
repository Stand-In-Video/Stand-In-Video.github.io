  ...
  return (
    ...
    <section className="flex flex-col items-center text-center py-16">
      ...
      <div className="mt-6 text-sm sm:text-base text-muted-foreground">
        <p>
            <a href="https://xbwustc.com" target="_blank" rel="noopener noreferrer" className="underline">
              Bowen Xue
            </a>*,{" "}
            <a href="https://adam-duan.github.io/" target="_blank" rel="noopener noreferrer" className="underline">
              Zheng-Peng Duan
            </a>*,{" "}
            Qixin Yan, Wenjing Wang, Hao Liu, Chun-Le Guo, Chongyi Li, Chen Li, Jing LYU
          </p>
        <p className="mt-1">
          WeChat Vision, Tencent Inc. &emsp; VCIP, CS, Nankai University
        </p>
      </div>
